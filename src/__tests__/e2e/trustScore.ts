...
const calculateScoreLogicTests: TestCase[] = [
  {
    ...
    fn: async (runtime: IAgentRuntime) => {
      ...
      try {
        ...
        if (
          (createdCompData as any).trustScore !== 0 ||
          ((createdCompData as any).recommendations || []).length !== 0
        ) {
          throw new Error(
            `New user score expected 0, got ${(createdCompData as any).trustScore}`,
          );
        }
  ...
  },
  {
    ...
    fn: async (runtime: IAgentRuntime) => {
      ...
      try {
        ...
        if (Math.abs((updatedCompData as any).trustScore - expectedFinalScore) > 0.01) {
          throw new Error(
            `Expected score ${expectedFinalScore.toFixed(2)}, got ${(updatedCompData as any).trustScore.toFixed(2)}`,
          );
        }
  ...
  },
  {
    ...
    fn: async (runtime: IAgentRuntime) => {
      ...
      try {
        ...
        if (Math.abs((updatedCompData as any).trustScore - -100) > 0.01) {
          throw new Error(
            `Expected score ~-100 for scam BUY, got ${(updatedCompData as any).trustScore.toFixed(2)}`,
          );
        }
  ...
  },
  {
    ...
    fn: async (runtime: IAgentRuntime) => {
      ...
      try {
        ...
        if (Math.abs((updatedCompData as any).trustScore - 100) > 0.01) {
          throw new Error(
            `Expected score clamped at 100, got ${(updatedCompData as any).trustScore.toFixed(2)}`,
          );
        }
  ...
  },
  {
    ...
    fn: async (runtime: IAgentRuntime) => {
      ...
      try {
        ...
        if (
          Math.abs(
            ((updatedCompData as any).recommendations[0].metrics
    ...
    fn: async (runtime: IAgentRuntime) => {
      ...
      try {
        ...
        if (
          ...
          throw new Error(
            "Metric was incorrectly re-evaluated when it was fresh",
          );
        }
