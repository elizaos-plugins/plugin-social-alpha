      ...
      try {
        ...
        const mockService = {
          ...
          calculateUserTrustScore: async () => {
            logger.debug('[MockService EventsTest] calculateUserTrustScore called');
            return;
          },
    ...
    fn: async (runtime: IAgentRuntime) => {
      ...
      try {
        ...
        const mockService = {
          ...
          calculateUserTrustScore: async () => {
            logger.debug('[MockService EventsTest] calculateUserTrustScore called during update');
            return;
          },
        } as Partial<CommunityInvestorService>;
    ...
    fn: async (runtime: IAgentRuntime) => {
      ...
      try {
        ...
        const mockService = {
          ...
          calculateUserTrustScore: async () => {
            logger.debug('[MockService EventsTest] calculateUserTrustScore called for duplicate skip');
            return;
          },
        } as Partial<CommunityInvestorService>;
        (runtime.getService as any) = <T extends Service>(serviceType: string): T | null =>
    ...
    fn: async (runtime: IAgentRuntime) => {
      ...
      try {
        ...
        const mockService = {
          ...
          calculateUserTrustScore: async () => {
            logger.debug('[MockService EventsTest] calculateUserTrustScore called for token resolution failure');
            return;
          },
        } as Partial<CommunityInvestorService>;
        (runtime.getService as any) = <T extends Service>(st: string): T | null =>
